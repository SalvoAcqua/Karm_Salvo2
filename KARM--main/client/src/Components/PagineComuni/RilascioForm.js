        ...
        <div>
           <Container class="container">
                <Modal show={Err.corsa!=undefined} centered backdrop="static">
                    <ModalBody>
                        <Button variant="secondary" onClick={()=>clickPagamento()}>Calcola pagamento aggiuntivo</Button>
                        <Container style={{display:showContainer}} classtyle={{marginTop:"20px"}}>
                            ...
                            <Row>
                                <Button variant="secondary" onClick={()=>clickConferma()}>Conferma</Button>
                            </Row>
                        </Container>
                    </ModalBody>
                </Modal>
                ...
                <Row> 
                    ...
                    <form onSubmit={onSubmit}>
                        ...
                        <input type="text" id="luogoInd" name="luogoInd" size="30" onChange={(e)=>setRilascio({...rilascio,luogoInd: e.target.value})} title="Inserisci l'indirizzo del luogo in cui hai rilasciato il veicolo"/> <br/>
